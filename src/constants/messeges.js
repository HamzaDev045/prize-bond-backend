const Messages = {
  ...
  USER_ALREADY_EXIST_MESSAGE:
    "Oh dear! It seems like this user email or username already exists. Please try a different one.",
  ...
  USERNAME_NOT_FOUND:
    "Sorry, we couldn't find the username you provided. Please check and try again.",
  USER_BANNED:
